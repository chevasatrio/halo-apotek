    ...
    return (
        <div className={`rounded-2xl border ${styles.wrap} p-4`}>
            ...
            <div className="mt-3 text-xs text-slate-600">
                {confirmed
                    ? "Konfirmasi berhasil."
                    : "Tarik tombol ke kanan sampai penuh."}
            </div>
        </div>
    );
}
...
export default function DriverList() {
    ...
    const applyStart = (id) => {
        setData((prev) =>
            prev.map((x) =>
                x.id === id ? { ...x, delivery_state: "on_the_way" } : x
            )
        );
        closeModal();
    };
    ...
    const applyDone = (id) => {
        setData((prev) =>
            prev.map((x) =>
                x.id === id ? { ...x, delivery_state: "done" } : x
            )
        );
        closeModal();
    };
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                <div>
                    ...
                    <p className="text-sm text-slate-500">
                        Pantau tugas pengantaran berdasarkan driver yang
                        di-assign oleh kasir/admin.
                    </p>
                </div>
            ...
            <div className="bg-white border rounded-2xl shadow-sm overflow-hidden">
                <div className="px-5 py-4 border-b flex items-center justify-between">
                    ...
                    <button
                        ...
                        onClick={() =>
                            alert("Dummy refresh (nanti fetch backend)")
                        }
                    >
                        Refresh
                    </button>
            ...
            >
                {modal.row ? (
                    <div className="space-y-4">
                        ...
                        <div className="text-sm text-slate-700">
                            Apakah Anda siap memulai pengantaran untuk pesanan
                            ini?
                        </div>
            ...
            >
                {modal.row ? (
                    <div className="space-y-4">
                        ...
                        <div className="text-sm text-slate-700">
                            Pastikan pesanan sudah diterima pembeli. Jika sudah
                            yakin, selesaikan pengantaran.
                        </div>
