                ...
                <div className="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-slate-600">
                            (Dummy) Progress menyamping untuk halaman
                            pengiriman.
                        </p>
                    </div>
                ...
                <div className="mx-auto max-w-6xl px-4 py-6">
                    <div className="flex items-start justify-between gap-4">
                        <div>
                            ...
                            <p className="mt-1 text-sm text-slate-600">
                                Pantau estimasi, status pengantaran, dan bukti
                                sampai.
                            </p>
                        </div>
                            ...
                            <div className="border-b border-slate-100 px-5 py-4">
                                <div className="flex items-start justify-between gap-4">
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm text-slate-600">
                                            (Dummy) Animasi halus untuk
                                            menunjukkan “sedang berjalan”.
                                        </p>
                                    </div>

                                    <StatusPill
                                        tone={isCompleted ? "light" : "dark"}
                                    >
                                ...
                                <div className="grid gap-5 md:grid-cols-3">
                                    <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                                        ...
                                        <p className="mt-2 text-xs text-slate-500">
                                            Perkiraan dapat berubah sesuai
                                            kondisi jalan.
                                        </p>
                                    </div>
                                    ...
                                    <div className="rounded-2xl border border-slate-200 bg-white p-4">
                                        ...
                                        <p className="mt-2 text-xs text-slate-500">
                                            Kontak driver akan muncul saat API
                                            aktif.
                                        </p>
                                    </div>
                                    ...
                                    <div className="rounded-2xl border border-slate-200 bg-white p-4">
                                        ...
                                        <p className="mt-2 text-xs text-slate-500">
                                            Gunakan untuk referensi internal.
                                        </p>
                                    </div>
                                </div>
                  ...
                  `}</style>
                                ...
                                <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                    <p className="text-sm text-slate-600">
                                        Jika pesanan sudah diterima, tandai
                                        sebagai{" "}
                      ...
                      ${
                        ...
                        <div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
                            <div className="border-b border-slate-100 px-5 py-4">
                                ...
                                <p className="mt-1 text-sm text-slate-600">
                                    (Dummy) Foto ini nanti berasal dari driver
                                    (delivery_proof).
                                </p>
                            </div>
                            ...
                            <div className="px-5 py-6">
                                {hasProof ? (
                                    <div className="grid gap-5 md:grid-cols-2 items-start">
                                        ...
                                        <div className="rounded-2xl border border-slate-200 bg-white p-5">
                                            ...
                                            <p className="mt-4 text-xs leading-relaxed text-slate-500">
                                                Jika ada kendala, nanti kita
                                                bisa tambahkan fitur komplain /
                                                bantuan.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="rounded-2xl border border-dashed border-slate-200 bg-slate-50 p-6 text-center">
                                        ...
                                        <p className="mt-1 text-sm text-slate-600">
                                            Bukti akan muncul setelah driver
                        ...
                        <div className="sticky top-6 space-y-6">
                            <div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
                                ...
                                <div className="px-5 py-5 space-y-3">
                                    ...
                                    <p className="text-sm text-slate-600">
                                        ...
                                        , halaman ini menampilkan bukti foto
                                        pengantaran.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-slate-200 bg-slate-900 p-5 shadow-sm">
                                ...
                                <p className="mt-2 text-sm text-slate-200">
                                    Versi dummy ini mensimulasikan perubahan
                                    status shipping → completed. Nanti status
                                    mengikuti backend.
                                </p>
                            </div>
