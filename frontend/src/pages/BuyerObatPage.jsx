        ...
        const fetchProducts = async () => {
            ...
            try {
                ...
                if (!Array.isArray(data))
                    throw new Error("Format data products tidak valid.");
                ...
                const normalized = data.map((p) => {
                    ...
                    return {
                        ...
                        requiresPrescription:
                            inferRequiresPrescription(category),
                        rating: 4.6,
                    };
                });
            ...
            <section className="py-16 bg-gradient-to-br from-sky-50 via-white to-sky-100">
                <div className="max-w-6xl mx-auto px-6">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
                        <div>
                            ...
                            <p className="text-slate-500 mt-2 text-sm md:text-base max-w-xl">
                                Jelajahi daftar obat yang lebih lengkap. Gunakan
                                pencarian dan filter kategori untuk menemukan
                                obat yang kamu butuhkan.
                            </p>
                        </div>
                        ...
                        <div className="bg-white/80 backdrop-blur border border-slate-200 rounded-2xl shadow-sm px-4 py-3 text-xs md:text-sm max-w-xs">
                            ...
                            <p className="text-slate-500 mt-1">
                                Upload resep dokter kamu untuk memesan
                                antibiotik dan obat yang membutuhkan pengawasan.
                            </p>
                    ...
                    <div className="grid md:grid-cols-4 sm:grid-cols-2 gap-6">
                        {!loading && filteredProducts.length === 0 && (
                            <p className="text-sm text-slate-500 col-span-full">
                                Tidak ada obat yang cocok dengan
                                pencarian/kategori.
                            </p>
                        )}
                    ...
                    <p className="mt-4 text-[11px] text-slate-400">
                        *Penggunaan antibiotik dan obat tertentu harus mengikuti
                        anjuran dokter dan pengawasan tenaga kesehatan.
                    </p>
                </div>
            </section>
        </div>
