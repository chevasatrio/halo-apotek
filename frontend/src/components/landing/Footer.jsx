          ...
          "
                    >
                        ...
                        <p className="text-sm text-blue-100 mt-3 leading-relaxed">
                            Layanan apotek online & delivery yang membantu kamu
                            mendapatkan obat dengan aman, cepat, dan nyaman dari
                            rumah.
                        </p>
                ...
                <div>
                    ...
                    <p className="text-sm text-slate-400">
                        Untuk memesan obat, menyimpan keranjang, dan melacak
                        status pengiriman, kamu perlu masuk ke akun Halo-Apotek.
                    </p>
                ...
                <div className="text-sm">
                    ...
                    <p className="text-slate-400">
                        Kebijakan Privasi • Syarat & Ketentuan • Bantuan
                        Pelanggan
                    </p>

                    <p className="text-slate-500 mt-4">
                        © {new Date().getFullYear()} Halo-Apotek. All rights
                        reserved.
                    </p>
                </div>
            </div>
